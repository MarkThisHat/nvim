...
M.setup = function()
    return {
        ...
        ["@function.python"] = { fg = colors.yellow },
        ["@odp.base_constructor.python"] = { fg = colors.yellow },
        ["@constructor.python"] = { fg = colors.yellow, bold = true},
...
--tbd   ["@variable.member.python"] = { fg = colors.white },
--tbd   ["@odp.interpolation.python"] = { fg = colors.white },
    }
end
